  ...
  return (
    <div class="m-6">
      ...
      <p>
        ...
        <a
          href="https://www.termsfeed.com/blog/sample-privacy-policy-template/index.tsx"
          target="_blank"
        >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Splitzies.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Splitzies, accessible from{" "}
            <a
              href="https://splitzies.netlify.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://splitzies.netlify.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        <a
          href="https://www.termsfeed.com/privacy-policy-generator/index.tsx#faq-8"
          target="_blank"
        >
      ...
      <ul>
        <li>By email: plunkett.bryce.m@gmail.com</li>
      </ul>
    </div>
  );
};
